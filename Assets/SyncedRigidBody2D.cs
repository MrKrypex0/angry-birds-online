...
namespace Mirror.Experimental
{
    ...
    public class SyncedRigidBody2D : NetworkBehaviour
    {
        static readonly ILogger logger = LogFactory.GetLogger(typeof(SyncedRigidBody2D));
        ...
        [SerializeField] bool syncAngularVelocity = false;
